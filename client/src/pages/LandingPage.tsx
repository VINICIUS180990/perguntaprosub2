...
import { sendOptimizedLandingPageMessage, LANDING_PAGE_SYSTEM_PROMPT } from "../api";
...
export default function LandingPage() {
  ...
  async function enviarMensagem(mensagemTexto?: string) {
    ...
    try {
      const respostaIA = await sendOptimizedLandingPageMessage(historicoApi, contexto, LANDING_PAGE_SYSTEM_PROMPT);
